...
//     { title: 'Avg Deal Size', value: formatAmount(leads.length ? Math.floor(leads.reduce((sum, l) => sum + (l.estimatedValue || 0), 0)/leads.length) : 0), change: '+8%', icon: DollarSign, color: 'purple' },
//   ];
