...
// import { Users, Plus, Search, Filter, UserCheck, UserX, Clock, Mail, Phone, MapPin, Calendar, DollarSign } from 'lucide-react';
...
//   // allow id to be string|number for compatibility with previous UI usage
//   id: string | number;
// }
...
//       (list) => {
//         // store with id as string for consistency; preserve compatibility with numeric fallback
...
//         // joinDate will be set by helper if not provided
//       });
//       setNewEmployee({
//         name: '',
//         email: '',
...
//   // Render — UI left unchanged, only data sources changed
//   return (
...
//             {/* department filter uses department names from Firestore */}
...
//                 </SelectTrigger>
//                 <SelectContent>
//                   {/* live department list from Firestore */}
//                   {departmentsList.map((d) => (
